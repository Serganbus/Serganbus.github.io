...
(function(){
	...
	var each = helpers.each = function(loopable,callback,self){
		...
		getMaximumWidth = helpers.getMaximumWidth = function(domNode){
			...
			// SEGA what?
			var lMaximumWidth_int = (container.clientWidth > 0) ? container.clientWidth : domNode.width;
			return lMaximumWidth_int;
		},
		getMaximumHeight = helpers.getMaximumHeight = function(domNode){
			var container = domNode.parentNode;
			// TODO = check cross browser stuff with this.
			// SEGA what?
			var lMaximumHeight_int = (container.clientHeight > 0) ? container.clientHeight : domNode.height;
			return lMaximumHeight_int;
		},
	...
	Chart.Type.extend({
		...
		addData : function(segment, atIndex, silent){
			...
			this.segments.splice(index, 0, new this.SegmentArc({
				...
				percentage : this.calculateSegmentPercentage(segment.value),
		...
		calculateSegmentPercentage : function (value) {
			var lRetValue_num = value * 100 / this.total;
			return lRetValue_num.toFixed(2);
		},
